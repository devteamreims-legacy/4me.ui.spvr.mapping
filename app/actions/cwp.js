...
export const MAPPING_FETCH_CWPS_START = 'MAPPING_FETCH_CWPS_START';
export const MAPPING_FETCH_CWPS_FAIL = 'MAPPING_FETCH_CWPS_FAIL';
export const MAPPING_FETCH_CWPS_COMPLETE = 'MAPPING_FETCH_CWPS_COMPLETE';
...
export function refreshCwps() {
  return (dispatch, getState) => {
    ...
    */
    ...
    const apiUrl = api.rootPath + api.cwp.getAll;
...
export function complete(cwps = []) {
  return {
    type: MAPPING_FETCH_CWPS_COMPLETE,
    cwps
  };
}